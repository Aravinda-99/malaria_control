...
<section class="hero-section">
    <div class="hero-content">
        ...
        <a href="#" class="hero-cta-btn">අපව අමතන්න</a>
...
<script>
    (function () {
        ...
        var titles = [
            'ඔබේ පවුල ආරක්ෂා කරගන්න.\nමැලේරියාවට එරෙහිව සටන් කරන්න.',
            'දිස්ත්‍රික්ක අනුව මැලේරියා ව්‍යාප්තිය.',
            'කලාපය අනුව මැලේරියා ව්‍යාප්තිය.'
        ];
        var subtitles = [
            'මදුරු දැලක් යට නිදාගන්න. ආරක්ෂිතව සිටින්න. නිරෝගීව සිටින්න.',
            'රෝගීන්ගේ ප්‍රතිශතය, 2025 ලෝක සෞඛ්‍ය සංවිධානයේ වාර්තාව',
            'රෝගීන්ගේ ප්‍රතිශතය, 2025 WHO වාර්තාව.'
        ];
        var current = 0;
        var intervalMs = 5000;
        var timerId;
